...
<View style={styles.navbar}>
      ...
      {/* Экран с содержимым */}<ScrollView>
        ...
        <TouchableOpacity style={{borderRadius:15, alignItems: 'center',color: 'white',width:250, height:35,top:7,right:25}}>
        <LinearGradient
      ...
      >
          <Text style={{padding: 5,alignItems: 'center',color: 'white'}}>Не подписанные</Text></LinearGradient></TouchableOpacity>
          <TouchableOpacity style={{borderRadius:15, alignItems: 'center',color: 'white',width:250, top:-30,left:155}} onPress={() => navigation.navigate('Пoдпись')}>
        
          <Text style={{padding: 5,alignItems: 'center',color: 'black'}}>Подписанные</Text></TouchableOpacity>
      ...
      <TouchableOpacity style={styles.card}>
        <View style={{top:20}}>
        <Text style={{top:-30,backgroundColor:"#DF3434",borderRadius:15,padding: 5, alignItems: 'center',color: 'white'}}>Не подписан</Text>
      ...
      <LinearGradient
        ...
        style={styles.background}
      >
          <Text style={styles.breadcrumbsText}>Подписать</Text></LinearGradient>
