...
<View style={styles.navbar}>
        ...
        <TouchableOpacity style={styles.card} >
          <View style={styles.cardContent}>
            <Image source={require('./help.png')}
               />
                       <TouchableOpacity style={{borderRadius:15, alignItems: 'center',color: 'white',width:250, height:35,left:35}}>
        <LinearGradient
      ...
      >
          <Text style={{padding: 5,alignItems: 'center',color: 'white'}}>Откликнуться</Text></LinearGradient></TouchableOpacity>
          </View>
        </TouchableOpacity>
        <TouchableOpacity style={styles.card} >
          <View style={styles.cardContent}>
      ...
      >
        ...
        <TouchableOpacity style={styles.card} >
          <View style={styles.cardContent}>
            <Image source={require('./help.png')}
               />
                       <TouchableOpacity style={{borderRadius:15, alignItems: 'center',color: 'white',width:250, height:35,left:35}} onPress={() => navigation.navigate('Заявление')}>
        <LinearGradient
        colors={['#7AB478', '#365435']}
        start={{x:0, y:0}}
        end={{x:1, y:1}}
